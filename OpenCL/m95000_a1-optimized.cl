...
KERNEL_FQ void m95000_m04 (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    const u64 hash = MurmurHash (seed, w, pw_len);
...
KERNEL_FQ void m95000_m08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void m95000_m16 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void m95000_s04 (KERN_ATTR_BASIC ())
{
  /**
   * modifier
   */
...
KERNEL_FQ void m95000_s08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void m95000_s16 (KERN_ATTR_BASIC ())
{
}
