...
KERNEL_FQ void m95000_m04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    u64x hash = MurmurHash (seed, w, out_len);
...
KERNEL_FQ void m95000_m08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m95000_m16 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m95000_s04 (KERN_ATTR_RULES ())
{
  /**
   * modifier
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    const u32x out_len = apply_rules_vect_optimized (pw_buf0, pw_buf1, pw_len, rules_buf, il_pos, w + 0, w + 8);
...
KERNEL_FQ void m95000_s08 (KERN_ATTR_RULES ())
{
}

KERNEL_FQ void m95000_s16 (KERN_ATTR_RULES ())
{
}
